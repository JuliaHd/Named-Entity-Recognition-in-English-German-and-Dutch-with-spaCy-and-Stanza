...
Opens the three corporpus .tsv files used in this project and strips them of
their index numbering and language tags before appending every sentence
in the corpus to an empty list. Do not do anything but execute this module.

This module requires "csv".

Attributes: (superfluous??)
